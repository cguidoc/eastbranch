...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.end_date'
        db.alter_column(u'employee_entry', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 13, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Entry.end_date'
        db.alter_column(u'employee_entry', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
